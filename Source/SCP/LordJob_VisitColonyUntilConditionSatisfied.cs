...
namespace SCP
{
    public class LordJob_VisitColonyUntilConditionSatisfied : LordJob
    {
        private Faction faction;

        private IntVec3 chillSpot;

        public LordJob_VisitColonyUntilConditionSatisfied()
        {
        }

        public LordJob_VisitColonyUntilConditionSatisfied(Faction faction, IntVec3 chillSpot)
        {
